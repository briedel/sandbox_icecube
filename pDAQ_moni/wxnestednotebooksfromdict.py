...
class plotFrame(wx.Frame):
    ...
    def __init__(self, clicked, data):
        ...
        if self.l == 1:
            ...
            # The subplot convention starts at 1
            self.splt = self.fig.add_subplot(1,1,1, xlabel='Time', ylabel=clicked[0][3])
            ...
            for i in np.arange(l):
                ...
                self.splt=self.fig.add_subplot(l+1,2,i+1, xlabel='Time', ylabel=clicked[i][3])
                self.plt=self.splt.plot(times, d)
